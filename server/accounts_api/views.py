...
from admin_api.serializers import LeadAccountStatusPatchSerializer, LeadGetSerializer
...
class LeadView(APIView):
    def patch(self, request):
        ...
        account = lead.account_details.first()  # assume it's a related model instance
